...
if (count($_POST) && isset($_POST['title'])&& !empty($_POST['id_category']) && isset($_POST['short_description'])  && isset($_POST['description'])) {
  storePost($_POST['title'], $_POST['short_description'], $_POST['description'],$_POST['id_category']);
}
$cal = getCategories();
?>
<!DOCTYPE html>
                ...
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <option>انتخاب کنید</option>
                      ...
                      ?>
                        <option value="<?= $calcul['id'] ?>"><?= $calcul['title'] ?></option>
                      <?php
                      }
                      ?>
                    </select>
